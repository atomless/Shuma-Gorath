...
if [[ -n "${SHUMA_MONITORING_ROLLUP_RETENTION_HOURS:-}" ]]; then
  printf '%s\n' "SHUMA_MONITORING_ROLLUP_RETENTION_HOURS=${SHUMA_MONITORING_ROLLUP_RETENTION_HOURS}" >>"${LOCAL_ENV_FILE}"
fi
if [[ -n "${SHUMA_EVENT_LOG_IP_STORAGE_MODE:-}" ]]; then
  printf '%s\n' "SHUMA_EVENT_LOG_IP_STORAGE_MODE=${SHUMA_EVENT_LOG_IP_STORAGE_MODE}" >>"${LOCAL_ENV_FILE}"
fi
