...
class AdversarialCoverageContractUnitTests(unittest.TestCase):
    ...
    def test_coverage_contract_freezes_non_human_lane_fulfillment_matrix(self):
        ...
        self.assertEqual(
            categories["indexing_bot"]["coverage_basis"],
            "recent_sim_telemetry_receipts",
        )
        ...
        self.assertEqual(
            categories["ai_scraper_bot"]["coverage_basis"],
            "recent_sim_telemetry_receipts",
        )
        self.assertEqual(categories["automated_browser"]["runtime_lane"], "scrapling_traffic")
        self.assertEqual(
            categories["automated_browser"]["fulfillment_mode"],
            "browser_automation",
        )
        self.assertEqual(
            categories["automated_browser"]["coverage_basis"],
            "recent_sim_telemetry_receipts",
        )
        ...
        self.assertEqual(
            categories["http_agent"]["coverage_basis"],
            "recent_sim_telemetry_receipts",
        )
