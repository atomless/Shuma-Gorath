...
SHUMA_CHALLENGE_PUZZLE_CONFIG_MUTABLE=${SHUMA_CHALLENGE_PUZZLE_CONFIG_MUTABLE:-}
...
ensure_env_local_default_from_defaults "SHUMA_CHALLENGE_PUZZLE_CONFIG_MUTABLE"
