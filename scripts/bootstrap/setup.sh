...
SHUMA_LOCAL_CONTRIBUTOR_INGRESS_ENABLE=${SHUMA_LOCAL_CONTRIBUTOR_INGRESS_ENABLE:-}
...
SHUMA_BAN_STORE_OUTAGE_MODE=${SHUMA_BAN_STORE_OUTAGE_MODE:-}
...
ensure_env_local_default_from_defaults "SHUMA_RUNTIME_DEV_OVERSIGHT_WATCH_WINDOW_SECONDS"
ensure_env_local_default_from_defaults "SHUMA_LOCAL_PROD_DIRECT_MODE"
ensure_env_local_default_from_defaults "SHUMA_LOCAL_CONTRIBUTOR_INGRESS_ENABLE"
...
ensure_env_local_default_from_defaults "SHUMA_BAN_STORE_OUTAGE_MODE"
...
echo ""
echo -e "${YELLOW}📊 Dashboard: http://127.0.0.1:3000/shuma/dashboard/index.html${NC}"
echo ""
