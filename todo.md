...
- [ ] Keep dashboard/admin API same-origin by default: infer endpoint from page origin and remove normal endpoint editing; keep only a dev override path. (dashboard/index.html, dashboard/dashboard.js, docs/dashboard.md)
- [ ] Keep CORS closed by default (no cross-origin admin API surface); document this deployment/security posture explicitly. (src, docs/security-hardening.md, docs/deployment.md)
