...
- [ ] RSI-GAME-ARCH-1E1 Retire redundant dashboard machine-diagnostic surfaces from Red Team, Game Loop, and Diagnostics after observer-facing replacements.
  - Reference context:
    - [`docs/research/2026-03-29-dashboard-machine-diagnostic-surface-retirement-review.md`](../docs/research/2026-03-29-dashboard-machine-diagnostic-surface-retirement-review.md)
    - [`docs/plans/2026-03-29-dashboard-machine-diagnostic-surface-retirement-plan.md`](../docs/plans/2026-03-29-dashboard-machine-diagnostic-surface-retirement-plan.md)
    - [`docs/plans/2026-03-27-game-loop-architecture-alignment-and-retirement-plan.md`](../docs/plans/2026-03-27-game-loop-architecture-alignment-and-retirement-plan.md)
  - Closure gate:
    - `Red Team` keeps only adversary-sim controls plus `Recent Red Team Runs`; `Lane State`, `Lane Diagnostics`, `Status Truth`, `Judged Episode Basis`, and `Scrapling` are removed cleanly
    - `Game Loop` keeps only the observer-facing round, adversary, and defence sections; the lower machine-diagnostic sections are removed cleanly
    - `Diagnostics` removes `Defense Breakdown` cleanly and keeps the deeper subsystem sections
    - dashboard read paths, props, helpers, and components that existed only for those removed sections are deleted rather than left inert
    - tests, docs, and focused `make` targets stop asserting deleted sections and still prove the surviving architecture truthfully
    - proof: `make test-dashboard-game-loop-accountability`, `make test-dashboard-red-team-truth-basis`, `make test-dashboard-diagnostics-pane`, `make dashboard-build`
    - insufficient: deleting only markup while still fetching, adapting, storing, documenting, or testing dead dashboard surfaces
