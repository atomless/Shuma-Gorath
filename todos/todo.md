...
- Remaining adversary realism is now the hard prerequisite for later Game Loop and Tuning work. Until `SIM-REALISM-2J` and `SIM-REALISM-3A..3E` are landed, keep the later Game Loop refactor or mixed-attacker proof chain and the later Tuning realignment chain blocked rather than execution-ready.
