...
- [ ] MON-OVERHAUL-1 Redesign Monitoring as an operator decision surface with explicit enforced-vs-shadow separation and clear attacker-effectiveness vs human-friction visibility.
  Blocker: the backend telemetry-foundation blocker is now cleared per [`../docs/research/2026-03-19-pre-monitoring-overhaul-telemetry-foundation-closeout-review.md`](../docs/research/2026-03-19-pre-monitoring-overhaul-telemetry-foundation-closeout-review.md). The remaining prerequisite is the Monitoring section-ownership and composition plan, to be written after user alignment on how the Monitoring operator surface should be organized.
