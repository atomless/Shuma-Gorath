...
- Full, canonical variable reference (environment-only variables + <abbr title="Key-Value">KV</abbr>-backed admin-editable runtime settings): `docs/configuration.md`
