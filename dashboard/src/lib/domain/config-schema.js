...
const controllerTunableAdminConfigPathSet = new Set([
  'js_required_enforced',
  'maze_enabled',
  'maze_auto_ban',
  'maze_rollout_phase',
...
const manualOnlyAdminConfigPathSet = new Set(['rate_limit']);

const neverAdminConfigPathSet = new Set([
  'shadow_mode',
  'adversary_sim_duration_seconds',
  'ban_duration',
  'ban_durations.honeypot',
...
export const adminConfigControllerMutabilityPaths = Object.freeze({
  controller_tunable: Object.freeze(
    advancedConfigTemplatePaths.filter((path) => controllerTunableAdminConfigPathSet.has(path))
  ),
  manual_only: Object.freeze(
    advancedConfigTemplatePaths.filter((path) => manualOnlyAdminConfigPathSet.has(path))
  ),
  never: Object.freeze(
    advancedConfigTemplatePaths.filter((path) => neverAdminConfigPathSet.has(path))
  )
});
