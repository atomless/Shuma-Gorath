...
- [`2026-03-24-deployer-ready-privacy-and-cookie-disclosure-template-review.md`](2026-03-24-deployer-ready-privacy-and-cookie-disclosure-template-review.md) - Defines the deployer-facing privacy and cookie notice template structure for current Shuma deployments
- [`2026-03-24-sec-gdpr-4-deployer-ready-privacy-and-cookie-disclosure-template-post-implementation-review.md`](2026-03-24-sec-gdpr-4-deployer-ready-privacy-and-cookie-disclosure-template-post-implementation-review.md) - Closeout for the publishable deployer-ready privacy and cookie disclosure template
- [`2026-03-24-github-actions-node24-major-refresh-review.md`](2026-03-24-github-actions-node24-major-refresh-review.md) - Defines the minimal Node24-safe GitHub Actions major refresh strategy
- [`2026-03-24-ci-wf-1-node24-major-refresh-post-implementation-review.md`](2026-03-24-ci-wf-1-node24-major-refresh-post-implementation-review.md) - Closeout for refreshing workflow action pins off the older Node20-backed majors
