...
- [`2026-03-27-game-loop-restriction-recognition-and-abuse-confidence-review.md`](2026-03-27-game-loop-restriction-recognition-and-abuse-confidence-review.md) - Clarifies the three-rail Game Loop architecture, separates restriction from recognition, and adds abuse-driven confidence escalation as the backstop
- [`2026-03-27-game-loop-architecture-alignment-gap-review.md`](2026-03-27-game-loop-architecture-alignment-gap-review.md) - Audits the current code path against the newer Game Loop design and identifies the cross-cutting rail split, controller cleanup, and retirement work still required
- [`2026-03-27-rsi-game-arch-1a-restriction-vs-recognition-snapshot-split-post-implementation-review.md`](2026-03-27-rsi-game-arch-1a-restriction-vs-recognition-snapshot-split-post-implementation-review.md) - Closeout for splitting restriction-grade non-human evidence from recognition-evaluation and simulator ground truth in snapshot and benchmark assembly
- [`2026-03-27-rsi-game-arch-1b-restriction-first-score-spine-post-implementation-review.md`](2026-03-27-rsi-game-arch-1b-restriction-first-score-spine-post-implementation-review.md) - Closeout for demoting category posture out of the primary restriction spine and projecting it as recognition evaluation instead
- [`2026-03-27-rsi-game-arch-1c-controller-contract-post-implementation-review.md`](2026-03-27-rsi-game-arch-1c-controller-contract-post-implementation-review.md) - Closeout for making controller diagnosis, recognition evaluation, and move selection explicit sibling contracts instead of leaning on one escalation-hint oracle
- [`2026-03-27-rsi-game-arch-1d-and-board-1g-breach-locus-honesty-post-implementation-review.md`](2026-03-27-rsi-game-arch-1d-and-board-1g-breach-locus-honesty-post-implementation-review.md) - Closeout for making breach-locus materialization truth explicit end to end so missing attempt, host-cost, and repair data no longer collapse into fake zeroes on the Game Loop
- [`2026-03-27-rsi-game-board-1f-loop-actionability-grouping-post-implementation-review.md`](2026-03-27-rsi-game-board-1f-loop-actionability-grouping-post-implementation-review.md) - Closeout for turning Loop Actionability into grouped root-cause, controller-outcome, and next-fix output instead of one blocker dump
- [`2026-03-27-game-loop-restriction-tuning-purity-live-gap-review.md`](2026-03-27-game-loop-restriction-tuning-purity-live-gap-review.md) - Captures the last recognition-leakage and simulator-persona purity break that was still preventing restriction tuning from acting on strong Scrapling board pressure
- [`2026-03-27-rsi-game-arch-1f-restriction-tuning-purity-post-implementation-review.md`](2026-03-27-rsi-game-arch-1f-restriction-tuning-purity-post-implementation-review.md) - Closeout for removing recognition-side blocker leakage and replacing simulator-persona gating with recent-window board evidence in restriction tuning
...
- [`2026-03-27-rsi-game-arch-1k-post-canary-candidate-window-review.md`](2026-03-27-rsi-game-arch-1k-post-canary-candidate-window-review.md) - Evaluates how to auto-materialize one protected post-canary candidate window and recommends keeping adversary generation with the adversary-sim supervisor rather than the oversight controller
- [`2026-03-28-rsi-game-arch-1k-post-canary-candidate-window-post-implementation-review.md`](2026-03-28-rsi-game-arch-1k-post-canary-candidate-window-post-implementation-review.md) - Closeout for making the supervisor auto-materialize one protected post-canary Scrapling follow-on run, exposing candidate-window lifecycle truth, and letting periodic judgment consume real candidate evidence
- [`2026-03-27-rsi-score-2f2-recognition-evaluation-rail-post-implementation-review.md`](2026-03-27-rsi-score-2f2-recognition-evaluation-rail-post-implementation-review.md) - Closeout for making the recognition side quest honest: current collapse to `unknown_non_human` now counts as real Shuma inference, while harness-only projected sim categories no longer masquerade as degraded matches
- [`2026-03-27-rsi-score-2f3-confidence-and-abuse-backstop-post-implementation-review.md`](2026-03-27-rsi-score-2f3-confidence-and-abuse-backstop-post-implementation-review.md) - Closeout for making restriction urgency explicitly carry Shuma confidence and the abuse-driven backstop while keeping simulator labels out of runtime and tuning
- [`2026-03-27-sim-scr-full-1c5-owned-surface-dependency-post-implementation-review.md`](2026-03-27-sim-scr-full-1c5-owned-surface-dependency-post-implementation-review.md) - Closeout for making owned-surface dependency or independence explicit end to end across coverage receipts, Red Team, and Game Loop
...
- [`2026-03-27-game-loop-current-state-and-gap-review.md`](2026-03-27-game-loop-current-state-and-gap-review.md) - Explains in plain terms how the Game Loop works today, how its scoring is computed, and why it is still closer to a judge plus bounded config harness than a fully self-improving defense loop
...
- [`2026-03-27-game-loop-scrapling-proof-and-rigor-gap-review.md`](2026-03-27-game-loop-scrapling-proof-and-rigor-gap-review.md) - Captures the still-open Scrapling-first rigor gaps: vague actionability blockers, vague breach loci, wholly unscored current Scrapling categories, incomplete JS/PoW surface proof, and implicit surface-dependency semantics
- [`2026-03-27-sim-scr-full-1c4-surface-exercise-proof-post-implementation-review.md`](2026-03-27-sim-scr-full-1c4-surface-exercise-proof-post-implementation-review.md) - Closeout for making current Scrapling owned-surface exercise proof explicit and operator-visible as `satisfied`, `attempted and blocked`, or `required but unreached`
- [`2026-03-27-game-loop-shared-path-locality-and-actionability-post-implementation-review.md`](2026-03-27-game-loop-shared-path-locality-and-actionability-post-implementation-review.md) - Closeout for the March 27 Game Loop slice: honest unscored category posture, breach-local host-cost attribution, exploit-progress-driven config moves, and cleaner board-state projection
- [`2026-03-27-human-friction-calibration-ring-review.md`](2026-03-27-human-friction-calibration-ring-review.md) - Research review defining the later real-human calibration ring over journey success, defense burden, and burn-rate style human-friction budgets
