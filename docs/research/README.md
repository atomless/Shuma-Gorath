...
- [`2026-03-25-sim-llm-browser-1-container-browser-mode-readiness-review.md`](2026-03-25-sim-llm-browser-1-container-browser-mode-readiness-review.md) - Defines the next real LLM attacker blocker: browser-mode execution inside the existing containerized black-box lane
- [`2026-03-25-sim-llm-browser-1-container-browser-mode-post-implementation-review.md`](2026-03-25-sim-llm-browser-1-container-browser-mode-post-implementation-review.md) - Closeout for landing executed `bot_red_team` browser-mode fulfillment in the existing container seam and clearing the mixed-attacker strict-loop blocker
...
- [`2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-readiness-review.md`](2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-readiness-review.md) - Defines the first atomic mixed-attacker strict-baseline proof slice now that the `bot_red_team` browser-mode blocker is closed
- [`2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-post-implementation-review.md`](2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-post-implementation-review.md) - Closeout for proving the first strict-baseline handoff from retained Scrapling pressure into a later `bot_red_team` canary without adding new runtime machinery
...
- [`2026-03-25-sim-llm-browser-1-container-browser-mode-post-implementation-review.md`](2026-03-25-sim-llm-browser-1-container-browser-mode-post-implementation-review.md) - Closeout for finishing the bounded browser-mode execution seam and unblocking the combined-attacker strict-loop tranche
...
- [`2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-post-implementation-review.md`](2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-post-implementation-review.md)
