...
- Surfaces:
  ...
  - and an observer-facing defence cast built from the selected round’s receipt-backed Scrapling surface rows, so the page stays surface-native and round-specific rather than reusing simulator labels as defence truth.
