...
7. `SIM-SCR-CHALLENGE-2C`, `SIM-SCR-BROWSER-1`, and `SIM-LLM-1` in [`../../todos/blocked-todo.md`](../../todos/blocked-todo.md)
...
7. The next concrete readiness step is now a contributor-friendly hostile-proxy setup chain: repo-owned setup and validation commands, local sidecars, and an optional agent-facing runbook or skill adapter over that canonical workflow rather than ad hoc external operator work.
8. On the canonical Linode shared-host path, that readiness chain should target the already-deployed root-hosted Shuma site itself. Do not reopen planning for a second synthetic public target there; the remaining work is remote-aware hostile egress setup and validation.
9. No further Game Loop or Tuning implementation should proceed while the target environment still reports only partial or degraded hostile-lane readiness, because later loop accountability and tuning work would otherwise still be calibrated against attacker traffic that the code now truthfully labels as non-representative for that environment.
10. The current request-native Scrapling and first-working-game-loop proofs remain important, but they are now treated as baseline capability rather than the unlock condition for stance relaxation or later LLM runtime work.
11. The later LLM attacker runtime remains decomposed as `SIM-LLM-1C1..1C3`, but those slices are now intentionally downstream of `STANCE-MODEL-1`, `SIM-SCR-FULL-1`, and `RSI-GAME-HO-1` rather than the next active backend mainline.
12. The next adversary-side truth gap is now environment operability through contributor-friendly hostile proxy-pool setup and validation on top of the landed representativeness gate; the earlier root-served defence confrontation and Scrapling cadence recovery slice is now landed on the generated public site.
13. The realism regression slice is now closed: on the current generated root-hosted site, root-started Scrapling now proves policy-served defence confrontation from ordinary public entrypoints, honest hostile-surface coverage, earned tarpit escalation on the real defence path for sufficiently aggressive personas, and much faster bursty mode turnover. See [`2026-04-01-root-served-defence-confrontation-and-scrapling-cadence-regression-plan.md`](2026-04-01-root-served-defence-confrontation-and-scrapling-cadence-regression-plan.md).
14. The discoverability part of the realism chain now has an explicit implementation vehicle: replace the thin hard-coded dummy site with a contributor-generated public-content site that is visible on local dev even when sim is idle, remains bounded by the no-hidden-catalog rule, and is served from the protected host root rather than a simulation-only prefix.
15. That generated-site chain now sits ahead of further realism work because it materially changes the public terrain the lanes should be tested against, and because the control-plane namespace must be corrected at the same time so the host root is not polluted with Shuma-owned admin or operational routes.
16. See [`2026-03-23-monitoring-loop-accountability-and-diagnostics-focus-plan.md`](2026-03-23-monitoring-loop-accountability-and-diagnostics-focus-plan.md), [`2026-03-24-monitoring-reuse-first-diagnostics-cleanup-sequencing-plan.md`](2026-03-24-monitoring-reuse-first-diagnostics-cleanup-sequencing-plan.md), [`2026-03-24-mainline-resequence-scrapling-before-game-loop-plan.md`](2026-03-24-mainline-resequence-scrapling-before-game-loop-plan.md), [`2026-03-24-reference-stance-and-run-to-homeostasis-implementation-plan.md`](2026-03-24-reference-stance-and-run-to-homeostasis-implementation-plan.md), [`2026-03-25-scrapling-full-power-human-only-loop-before-relaxation-plan.md`](2026-03-25-scrapling-full-power-human-only-loop-before-relaxation-plan.md), [`2026-03-25-canonical-non-human-stance-and-verified-identity-override-plan.md`](2026-03-25-canonical-non-human-stance-and-verified-identity-override-plan.md), [`2026-03-30-adversary-lane-traffic-realism-and-cadence-plan.md`](2026-03-30-adversary-lane-traffic-realism-and-cadence-plan.md), [`2026-03-30-adversary-lane-wild-traffic-gap-plan.md`](2026-03-30-adversary-lane-wild-traffic-gap-plan.md), [`2026-03-30-contributor-generated-public-content-sim-site-plan.md`](2026-03-30-contributor-generated-public-content-sim-site-plan.md), [`2026-03-31-route-namespace-and-root-hosted-public-site-plan.md`](2026-03-31-route-namespace-and-root-hosted-public-site-plan.md), [`2026-04-01-root-served-defence-confrontation-and-scrapling-cadence-regression-plan.md`](2026-04-01-root-served-defence-confrontation-and-scrapling-cadence-regression-plan.md), and [`2026-04-01-contributor-friendly-adversary-proxy-pool-setup-plan.md`](2026-04-01-contributor-friendly-adversary-proxy-pool-setup-plan.md).
