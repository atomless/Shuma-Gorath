...
5. The immediate next execution priority inside that sequence is now the route-correction-plus-generated-site chain: `ROUTE-NS-1A`, `ROUTE-NS-1B`, `ROUTE-NS-1C`, `ROUTE-NS-1D`, `ROUTE-NS-1E`, and `ROUTE-NS-1F`. That route correction subsumes the earlier `/sim/public/*` site assumption by making the generated public surface root-hosted and moving Shuma-owned dashboard, admin, health, metrics, and internal routes under `/shuma/*`. After that, resume `SIM-REALISM-1C`, then `SIM-REALISM-1D`, and then the field-grounded follow-on order `SIM-REALISM-2A`, `SIM-REALISM-2B`, `SIM-REALISM-2C`, `SIM-REALISM-2D`, and `SIM-REALISM-2E`.
6. The current request-native Scrapling and first-working-game-loop proofs remain important, but they are now treated as baseline capability rather than the unlock condition for stance relaxation or later LLM runtime work.
7. The later LLM attacker runtime remains decomposed as `SIM-LLM-1C1..1C3`, but those slices are now intentionally downstream of `STANCE-MODEL-1`, `SIM-SCR-FULL-1`, and `RSI-GAME-HO-1` rather than the next active backend mainline.
8. The next adversary-side truth gap is no longer route knowledge or category ownership. It is behavior realism across two layers: first local cadence or dwell or burst contracts, then field-grounded pressure, identity, transport, browser-background, and recurrence realism.
9. The discoverability part of the realism chain now has an explicit implementation vehicle: replace the thin hard-coded dummy site with a contributor-generated public-content site that is visible on local dev even when sim is idle, remains bounded by the no-hidden-catalog rule, and is served from the protected host root rather than a simulation-only prefix.
10. That generated-site chain now sits ahead of further realism work because it materially changes the public terrain the lanes should be tested against, and because the control-plane namespace must be corrected at the same time so the host root is not polluted with Shuma-owned admin or operational routes.
11. See [`2026-03-23-monitoring-loop-accountability-and-diagnostics-focus-plan.md`](2026-03-23-monitoring-loop-accountability-and-diagnostics-focus-plan.md), [`2026-03-24-monitoring-reuse-first-diagnostics-cleanup-sequencing-plan.md`](2026-03-24-monitoring-reuse-first-diagnostics-cleanup-sequencing-plan.md), [`2026-03-24-mainline-resequence-scrapling-before-game-loop-plan.md`](2026-03-24-mainline-resequence-scrapling-before-game-loop-plan.md), [`2026-03-24-reference-stance-and-run-to-homeostasis-implementation-plan.md`](2026-03-24-reference-stance-and-run-to-homeostasis-implementation-plan.md), [`2026-03-25-scrapling-full-power-human-only-loop-before-relaxation-plan.md`](2026-03-25-scrapling-full-power-human-only-loop-before-relaxation-plan.md), [`2026-03-25-canonical-non-human-stance-and-verified-identity-override-plan.md`](2026-03-25-canonical-non-human-stance-and-verified-identity-override-plan.md), [`2026-03-30-adversary-lane-traffic-realism-and-cadence-plan.md`](2026-03-30-adversary-lane-traffic-realism-and-cadence-plan.md), [`2026-03-30-adversary-lane-wild-traffic-gap-plan.md`](2026-03-30-adversary-lane-wild-traffic-gap-plan.md), [`2026-03-30-contributor-generated-public-content-sim-site-plan.md`](2026-03-30-contributor-generated-public-content-sim-site-plan.md), and [`2026-03-31-route-namespace-and-root-hosted-public-site-plan.md`](2026-03-31-route-namespace-and-root-hosted-public-site-plan.md).
