...
2. Do not reopen `TUNE-SURFACE-2`, `TUNE-SURFACE-2A`, `TUNE-SURFACE-2B`, `TUNE-BAN-1`, or `TUNE-BAN-2` while `SIM-REALISM-2F..2J` and `SIM-REALISM-3A..3E` remain open.
3. The reason is now explicit: Tuning must optimize against representative attacker pressure, and that representation still falls short on traversal depth, frontier truth, richer root-host public terrain, trusted-ingress identity realism, overlapping mixed-lane pressure, richer agentic capability, and explicit representativeness gating.
...
6. The live next execution priority inside that sequence is now the remaining realism chain: `SIM-REALISM-2F`, `SIM-REALISM-2G`, `SIM-REALISM-2H`, `SIM-REALISM-2I`, `SIM-REALISM-2J`, `SIM-REALISM-3A`, `SIM-REALISM-3B`, `SIM-REALISM-3C`, `SIM-REALISM-3D`, and `SIM-REALISM-3E`.
7. No further Game Loop or Tuning implementation should proceed while those remaining realism tranches are still open, because later loop accountability and tuning work would otherwise be calibrated against attacker traffic that still falls short on traversal depth, frontier truth, richer public terrain, realistic client-IP posture, overlapping mixed-lane pressure, richer agentic capability, longer-window return behavior, and explicit representativeness gating.
