...
7. The next concrete readiness step is now a contributor-friendly hostile-proxy setup chain: repo-owned setup and validation commands, local sidecars, and an optional skill wrapper over that canonical workflow rather than ad hoc external operator work.
