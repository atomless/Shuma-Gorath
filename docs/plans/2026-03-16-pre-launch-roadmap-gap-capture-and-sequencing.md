...
4. That operator-surface cleanup is no longer the immediate mainline. Attacker-faithful Scrapling and the first explicit self-improving loop now sit ahead of `TRAFFIC-TAB-1`, `DIAG-CLEANUP-1`, and `MON-OVERHAUL-1C`.
5. With that attacker-faithful Scrapling and first-working-game-loop path now landed, the next highest-leverage follow-on is a narrow testing-ergonomics tranche that makes the active mainline cheap and truthful to verify before deferred dashboard cleanup resumes.
6. With `SIM-LLM-1A` and `SIM-LLM-1B` now landed, the later LLM attacker runtime is no longer truthfully one blocked umbrella; it should reopen as `SIM-LLM-1C1..1C3` over live frontier action generation, supervisor/result wiring, and runtime proof closure.
7. See [`2026-03-23-monitoring-loop-accountability-and-diagnostics-focus-plan.md`](2026-03-23-monitoring-loop-accountability-and-diagnostics-focus-plan.md), [`2026-03-24-monitoring-reuse-first-diagnostics-cleanup-sequencing-plan.md`](2026-03-24-monitoring-reuse-first-diagnostics-cleanup-sequencing-plan.md), [`2026-03-24-mainline-resequence-scrapling-before-game-loop-plan.md`](2026-03-24-mainline-resequence-scrapling-before-game-loop-plan.md), [`2026-03-24-reference-stance-and-run-to-homeostasis-implementation-plan.md`](2026-03-24-reference-stance-and-run-to-homeostasis-implementation-plan.md), [`2026-03-25-testing-suite-structure-and-mainline-friction-plan.md`](2026-03-25-testing-suite-structure-and-mainline-friction-plan.md), and [`2026-03-25-sim-llm-1c-runtime-decomposition-plan.md`](2026-03-25-sim-llm-1c-runtime-decomposition-plan.md).
