...
5. The immediate next execution priority inside that sequence is still `SIM-REALISM-1C`, followed by `SIM-REALISM-1D`. After that, the field-grounded follow-on order is `SIM-REALISM-2A`, `SIM-REALISM-2B`, `SIM-REALISM-2C`, `SIM-REALISM-2D`, and `SIM-REALISM-2E`.
