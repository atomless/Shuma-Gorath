...
**Architecture:** Treat the root `README.md` as the repo’s highest-traffic navigation surface. It should summarize the current docs topology, not compete with or contradict `docs/index.md`.
...
**Steps:**
1. Add a short “Start here” group that points to `docs/index.md`, `docs/current-system-architecture.md`, and the current shared-host-first operating docs.
