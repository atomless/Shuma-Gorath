...
Supersedes: Historical baseline in [`docs/plans/archive/2026-02-13-maze-excellence-plan.md`](archive/2026-02-13-maze-excellence-plan.md)
...
2. MZ-T2: Add browser E2E coverage for live maze behavior.
   - Cover JS-enabled and JS-disabled paths, replay rejection, checkpoint/micro-PoW behavior, and high-confidence escalation outcomes.

3. MZ-T3: Add concurrency/soak coverage for maze state/budget primitives.
   - Validate replay/checkpoint/budget key behavior under burst traversal and confirm bounded host-write behavior.

4. MZ-T4: Wire the new integration/E2E/soak coverage into canonical Makefile + CI gates.
