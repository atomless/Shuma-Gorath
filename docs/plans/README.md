...
- [`2026-03-25-sim-llm-browser-1-container-browser-mode-plan.md`](2026-03-25-sim-llm-browser-1-container-browser-mode-plan.md) - Lands executed browser-mode fulfillment for `bot_red_team` inside the existing containerized black-box lane
...
- [`2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-plan.md`](2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-plan.md) - Adds the first strict-baseline mixed-attacker proof slice with both Scrapling and `bot_red_team` pressure in the same Game Loop story
...
- [`2026-03-25-sim-scr-full-1b2b-browser-challenge-interactions-plan.md`](2026-03-25-sim-scr-full-1b2b-browser-challenge-interactions-plan.md) - Lands the first real browser-backed not-a-bot and puzzle interactions for Scrapling-owned DOM challenge surfaces while keeping PoW and tarpit request-native
- [`2026-03-25-sim-scr-full-1b3-remaining-gap-closure-plan.md`](2026-03-25-sim-scr-full-1b3-remaining-gap-closure-plan.md) - Closes the remaining full-power gap as an explicit omission-ledger and sequencing truth tranche once no further owned-surface browser or stealth behavior remains before receipt-backed proof
- [`2026-03-25-sim-scr-full-1c-receipt-proof-plan.md`](2026-03-25-sim-scr-full-1c-receipt-proof-plan.md) - Closes the full-power Scrapling tranche by proving touched surfaces, expected pass or fail outcomes, and exercised categories or surfaces across backend recent-run closure plus Red Team and Game Loop operator evidence
...
- [`2026-03-25-sim-llm-browser-1-container-browser-mode-plan.md`](2026-03-25-sim-llm-browser-1-container-browser-mode-plan.md)
...
- [`2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-plan.md`](2026-03-25-rsi-game-ho-2a-combined-attacker-baseline-plan.md)
