...
- [`2026-03-27-game-loop-scrapling-proof-and-rigor-repair-plan.md`](2026-03-27-game-loop-scrapling-proof-and-rigor-repair-plan.md) - Drives the next Scrapling-first Game Loop repairs over exact surface-exercise proof, explicit surface dependencies, exact category scoring, typed actionability blockers, and surface-exact breach loci
