...
- [`2026-03-24-fingerprint-state-retention-cleanup-plan.md`](2026-03-24-fingerprint-state-retention-cleanup-plan.md) - Plans bounded cadence-gated cleanup for stale fingerprint state and flow keys without widening into a general retention worker
- [`2026-03-24-event-log-ip-storage-minimization-plan.md`](2026-03-24-event-log-ip-storage-minimization-plan.md) - Adds an env-only event-log IP storage mode with truthful forensic tradeoff surfacing
- [`2026-03-24-deployer-ready-privacy-and-cookie-disclosure-template-plan.md`](2026-03-24-deployer-ready-privacy-and-cookie-disclosure-template-plan.md) - Adds a deployer-ready privacy and cookie notice template aligned to current Shuma storage behavior
- [`2026-03-24-github-actions-node24-major-refresh-plan.md`](2026-03-24-github-actions-node24-major-refresh-plan.md) - Refreshes workflow pins off the older Node20-backed majors and adds a static contract lane
