...
test-adversarial-python-unit: ## Run adversarial python/js unit and syntax checks (no server required)
	...
	@python3 -m py_compile scripts/tests/adversarial_simulation_runner.py scripts/tests/adversary_runtime_toggle_surface_gate.py scripts/tests/adversarial_preflight.py scripts/tests/adversarial_live_loop.py scripts/tests/adversarial_repeatability.py scripts/tests/adversarial_promote_candidates.py scripts/tests/adversarial_report_diff.py scripts/tests/adversarial_container_runner.py scripts/tests/adversarial_container/worker.py scripts/tests/frontier_action_contract.py scripts/tests/frontier_capability_envelope.py scripts/tests/frontier_lane_attempt.py scripts/tests/frontier_unavailability_policy.py scripts/tests/check_frontier_payload_artifacts.py scripts/tests/check_adversarial_lane_contract.py scripts/tests/check_shared_host_scope_contract.py scripts/tests/check_shared_host_seed_contract.py scripts/tests/check_adversarial_sim_tag_contract.py scripts/tests/check_adversarial_coverage_contract.py scripts/tests/check_adversarial_scenario_intent_matrix.py scripts/tests/live_feedback_loop_remote.py scripts/tests/playwright_runtime.py scripts/tests/shared_host_scope.py scripts/tests/shared_host_seed_inventory.py scripts/tests/sim_tag_helpers.py scripts/tests/sim2_realtime_bench.py scripts/tests/check_sim2_adr_conformance.py scripts/tests/render_sim2_ci_diagnostics.py scripts/tests/check_sim2_verification_matrix.py scripts/tests/check_sim2_operational_regressions.py scripts/tests/check_sim2_governance_contract.py scripts/supervisor/scrapling_worker.py scripts/deploy/scrapling_deploy_prep.py scripts/prepare_scrapling_deploy.py
