...
test-test-mode-shadow: ## Run focused shadow-mode backend truthfulness checks
	@echo "$(CYAN)🧪 Running test-mode shadow backend checks...$(NC)"
	@./scripts/set_crate_type.sh rlib
	@cargo test runtime::test_mode::tests:: -- --nocapture
	...
	@cargo test admin::api::tests::log_event_with_execution_metadata_persists_shadow_fields -- --exact --nocapture
