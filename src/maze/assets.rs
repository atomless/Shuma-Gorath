...
static MAZE_WORKER_HASH: Lazy<String> = Lazy::new(|| hash_prefix(MAZE_WORKER_JS));
static MAZE_WORKER_PATH: Lazy<String> =
    Lazy::new(|| format!("/maze/assets/maze-worker.{}.min.js", MAZE_WORKER_HASH.as_str()));

static MAZE_SCRIPT_JS: Lazy<String> =
    Lazy::new(|| MAZE_SCRIPT_TEMPLATE.replace("__WORKER_PATH__", maze_worker_path()));
static MAZE_SCRIPT_HASH: Lazy<String> = Lazy::new(|| hash_prefix(MAZE_SCRIPT_JS.as_str()));
static MAZE_SCRIPT_PATH: Lazy<String> =
    Lazy::new(|| format!("/maze/assets/maze.{}.min.js", MAZE_SCRIPT_HASH.as_str()));

static MAZE_STYLE_HASH: Lazy<String> = Lazy::new(|| hash_prefix(MAZE_STYLE_CSS));
static MAZE_STYLE_PATH: Lazy<String> =
    Lazy::new(|| format!("/maze/assets/maze.{}.min.css", MAZE_STYLE_HASH.as_str()));
...
mod tests {
    ...
    fn asset_paths_match_content_hashes() {
        ...
        let worker_hash = hash_prefix(MAZE_WORKER_JS);
