...
pub(crate) fn handle_internal_adversary_sim_worker_result(
    ...
    let now = match schema_version {
        ...
        crate::admin::adversary_sim::LLM_RUNTIME_RESULT_SCHEMA_VERSION => {
            ...
            log_llm_runtime_receipt_event(store, &worker_result);
...
fn log_llm_runtime_receipt_event(
    store: &impl crate::challenge::KeyValueStore,
    ...
    let record = super::api::EventLogRecord {
        entry: super::api::EventLogEntry {
            ...
            outcome: Some(format!(
                "tick_id={} mode={} source={} generated_actions={} executed_actions={} failed_actions={}",
                worker_result.tick_id,
                worker_result.fulfillment_mode,
                worker_result.generation_source,
        ...
        sim_profile: Some(format!(
            "{}.{}",
            crate::admin::adversary_sim::LLM_SIM_PROFILE,
            worker_result.fulfillment_mode
        )),
        sim_lane: Some(worker_result.lane.as_str().to_string()),
        is_simulation: true,
