...
pub(super) struct AllowedActionValueConstraintDefinition {
    pub(super) path: &'static str,
    pub(super) value_kind: &'static str,
    pub(super) min_inclusive: Option<f64>,
    pub(super) max_inclusive: Option<f64>,
    pub(super) allowed_values: &'static [&'static str],
    pub(super) rule: Option<&'static str>,
}
...
pub(super) const CONTROLLER_TUNABLE_ADMIN_CONFIG_PATHS: &[&str] = &[
...
pub(super) const MANUAL_ONLY_ADMIN_CONFIG_PATHS: &[&str] = &["rate_limit"];

pub(super) const NEVER_ADMIN_CONFIG_PATHS: &[&str] = &[
    "shadow_mode",
...
pub(super) const NEVER_OPERATOR_OBJECTIVES_PATHS: &[&str] = &[
    "operator_objectives_v1.profile_id",
    "operator_objectives_v1.window_hours",
    "operator_objectives_v1.compliance_semantics",
    "operator_objectives_v1.category_postures",
    "operator_objectives_v1.budgets",
    "operator_objectives_v1.adversary_sim_expectations",
    "operator_objectives_v1.rollout_guardrails",
];

const BOOLEAN_VALUES: &[&str] = &["false", "true"];
const MAZE_ROLLOUT_VALUES: &[&str] = &["instrument", "advisory", "enforce"];

const CORE_POLICY_JS_REQUIRED_CONSTRAINTS: &[AllowedActionValueConstraintDefinition] =
    &[AllowedActionValueConstraintDefinition {
        ...
        rule: Some(
            "Controller proposals that change human-facing friction toggles must be canary-reviewed before apply.",
        ),
    }];
...
const MAZE_ROLLOUT_CONSTRAINTS: &[AllowedActionValueConstraintDefinition] = &[
    AllowedActionValueConstraintDefinition {
        ...
        allowed_values: BOOLEAN_VALUES,
        rule: Some(
            "Controller proposals that enable or disable enforcement surfaces must be canary-reviewed before apply.",
        ),
    },
    AllowedActionValueConstraintDefinition {
        path: "maze_auto_ban",
        ...
        allowed_values: BOOLEAN_VALUES,
        rule: Some(
            "Automatic ban posture changes must remain bounded to canary-reviewed config diffs.",
        ),
    },
    AllowedActionValueConstraintDefinition {
        ...
        rule: Some(
            "Rollout-phase changes must stay within the explicit instrument/advisory/enforce progression.",
        ),
    },
];
...
const PROOF_OF_WORK_CONSTRAINTS: &[AllowedActionValueConstraintDefinition] = &[
    AllowedActionValueConstraintDefinition {
        ...
        allowed_values: BOOLEAN_VALUES,
        rule: Some(
            "PoW enablement changes must be canary-reviewed because they directly affect human friction.",
        ),
    },
    AllowedActionValueConstraintDefinition {
        path: "pow_difficulty",
...
const NOT_A_BOT_CONSTRAINTS: &[AllowedActionValueConstraintDefinition] = &[
    ...
    AllowedActionValueConstraintDefinition {
        ...
        allowed_values: &[],
        rule: Some(
            "When challenge_puzzle_risk_threshold is enabled, not_a_bot_risk_threshold must stay below it.",
        ),
    },
    AllowedActionValueConstraintDefinition {
...
const FINGERPRINT_POLICY_CONSTRAINTS: &[AllowedActionValueConstraintDefinition] = &[
    AllowedActionValueConstraintDefinition {
        ...
        allowed_values: BOOLEAN_VALUES,
        rule: Some(
            "Fingerprint-signal enablement changes must be canary-reviewed before apply.",
        ),
    },
    AllowedActionValueConstraintDefinition {
...
pub(super) const ALLOWED_ACTION_GROUP_DEFINITIONS: &[AllowedActionGroupDefinition] = &[
